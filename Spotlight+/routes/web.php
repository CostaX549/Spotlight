...
Route::get('/filmes/{id}', [FilmeController::class, 'show'])->name('filmes.show')->middleware('auth');
Route::get('/pesquisa', [PesquisaController::class, 'index'])->name('pesquisa.index')->middleware('auth');
...
Route::get('/series/{id}', [SerieController::class, 'show'])->name('series.show')->middleware('auth');  
Route::get('/documentarios/{id}', [DocumentarioController::class, 'show'])->name('documentarios.show');

Route::get('/', [PesquisaController::class, 'welcome'])->name('pesquisa.welcome')->middleware('auth');
